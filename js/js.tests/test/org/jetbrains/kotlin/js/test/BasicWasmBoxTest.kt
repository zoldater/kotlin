...
abstract class BasicWasmBoxTest(
    ...
    fun doTest(filePath: String) {
        ...
        TestFileFactoryImpl().use { testFactory ->
            ...
            val lvs = inputFiles.mapNotNull { it.languageVersionSettings }.firstOrNull()
    ...
    private fun createConfig(lvs: LanguageVersionSettings?): JsConfig {
        val configuration = environment.configuration.copy()
        configuration.put(CommonConfigurationKeys.MODULE_NAME, TEST_MODULE)
        configuration.languageVersionSettings = lvs ?: LanguageVersionSettingsImpl(LanguageVersion.KOTLIN_1_4, ApiVersion.KOTLIN_1_4)
