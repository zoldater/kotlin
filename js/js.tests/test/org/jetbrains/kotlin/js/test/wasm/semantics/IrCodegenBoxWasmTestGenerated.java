...
public class IrCodegenBoxWasmTestGenerated extends AbstractIrCodegenBoxWasmTest {
    ...
    public void testAllFilesPresentInBox() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/box"), Pattern.compile("^([^_](.+))\\.kt$"), TargetBackend.WASM, true, "annotations", "arrays", "assert", "boxingOptimization", "bridges", "builtinStubMethods", "callableReference", "casts", "checkcastOptimization", "classLiteral", "closures", "collectionLiterals", "collections", "compatibility", "constructorCall", "contracts", "coroutines", "dataClasses", "deadCodeElimination", "defaultArguments", "delegatedProperty", "delegation", "destructuringDeclInLambdaParam", "diagnostics", "elvis", "enum", "evaluate", "exclExcl", "external", "fakeOverride", "fieldRename", "finally", "fullJdk", "hashPMap", "inference", "inlineClasses", "innerNested", "javaInterop", "jdk", "jvm8", "jvmField", "jvmName", "jvmOverloads", "jvmPackageName", "jvmStatic", "localClasses", "mangling", "multiDecl", "multifileClasses", "nonLocalReturns", "nullCheckOptimization", "objects", "parametersMetadata", "platformTypes", "polymorphicSignature", "primitiveTypes", "private", "privateConstructors", "publishedApi", "ranges", "reflection", "reified", "safeCall", "sam", "sealed", "secondaryConstructors", "signatureAnnotations", "smap", "smartCasts", "specialBuiltins", "statics", "super", "synchronized", "syntheticAccessors", "toArray", "traits", "typealias", "typeInfo", "typeMapping", "unit", "unsignedTypes", "vararg");
    }
