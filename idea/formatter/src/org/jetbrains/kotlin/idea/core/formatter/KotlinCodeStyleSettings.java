...
public class KotlinCodeStyleSettings extends CustomCodeStyleSettings {
    ...
    public boolean CONTINUATION_INDENT_IN_PARAMETER_LISTS = false;
    public boolean CONTINUATION_INDENT_IN_ARGUMENT_LISTS = false;
    public boolean CONTINUATION_INDENT_FOR_EXPRESSION_BODIES = false;
    public boolean CONTINUATION_INDENT_FOR_CHAINED_CALLS = false;
    public boolean CONTINUATION_INDENT_IN_SUPERTYPE_LISTS = false;
    public boolean CONTINUATION_INDENT_IN_IF_CONDITIONS = false;
    public boolean CONTINUATION_INDENT_IN_ELVIS = false;
    public int BLANK_LINES_AROUND_BLOCK_WHEN_BRANCHES = 0;
    public int WRAP_EXPRESSION_BODY_FUNCTIONS = CommonCodeStyleSettings.WRAP_AS_NEEDED;
    public int WRAP_ELVIS_EXPRESSIONS = 1;
    public boolean IF_RPAREN_ON_NEW_LINE = true;
