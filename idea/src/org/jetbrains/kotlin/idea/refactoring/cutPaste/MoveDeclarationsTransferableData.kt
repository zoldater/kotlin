...
class MoveDeclarationsTransferableData(
    ...
    companion object {
        val DATA_FLAVOR: DataFlavor = DataFlavor(MoveDeclarationsCopyPasteProcessor::class.java, "class: MoveDeclarationsCopyPasteProcessor")

        val STUB_RENDERER: DescriptorRenderer = IdeDescriptorRenderers.SOURCE_CODE.withOptions {
