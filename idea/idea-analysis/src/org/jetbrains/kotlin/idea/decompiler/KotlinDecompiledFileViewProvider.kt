...
class KotlinDecompiledFileViewProvider(
    ...
    override fun createCopy(copy: VirtualFile): KotlinDecompiledFileViewProvider = KotlinDecompiledFileViewProvider(manager, copy, false, factory)

    override fun getContents(): String = content.get()
}