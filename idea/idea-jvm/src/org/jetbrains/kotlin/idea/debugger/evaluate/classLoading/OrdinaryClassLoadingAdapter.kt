...
class OrdinaryClassLoadingAdapter : ClassLoadingAdapter {
    private companion object {
        ...
        fun useMagicAccessor(evaluationContext: EvaluationContextImpl): Boolean {
            val session = evaluationContext.debugProcess.session.xDebugSession
            val javaVersion = CompilingEvaluatorImpl.getJavaVersion(session)
            return javaVersion != null && !javaVersion.isAtLeast(JavaSdkVersion.JDK_1_9)
        }
    }
