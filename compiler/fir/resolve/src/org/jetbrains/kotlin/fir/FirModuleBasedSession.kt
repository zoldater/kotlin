...
class FirCommonModuleBasedSession(moduleInfo: ModuleInfo) : FirModuleBasedSession(moduleInfo) {
    init {
        registerComponent(
            FirSymbolProvider::class,
            FirCompositeSymbolProvider(listOf(service<FirProvider>(), FirLibrarySymbolProviderImpl(this)))
        )
    }
}