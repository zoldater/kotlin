...
class FirPropertyGetterDescriptor(
    accessor: FirPropertyAccessor,
    property: FirPropertyDescriptor
) : FirAbstractPropertyAccessorDescriptor(accessor, property), PropertyGetterDescriptor {
    ...
    override fun getOverriddenDescriptors(): MutableCollection<out PropertyGetterDescriptor> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
    ...
    override fun getOriginal(): PropertyGetterDescriptor {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
