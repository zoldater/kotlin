...
class MutableVariableWithConstraints(
    ...
    override fun getErrorTypeFromConstraints(): UnwrappedType? {
        return mutableConstraints.mapNotNull {
            var errorType: UnwrappedType? = null
        ...
        fun addConstraint(constraint: Constraint): Constraint? {
            ...
            val previousConstraintWithSameType =
                constraints.filter { it.typeHashCode == constraint.typeHashCode && it.type == constraint.type }
