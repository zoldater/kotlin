...
class B2(x: List<Int>) : <!OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!><!NI;NEW_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>A<CharSequence><!>("", x)<!>
...
class C : A<CharSequence> {
    ...
    constructor(x: List<Int>, y: Int) : <!NI;NEW_INFERENCE_NO_INFORMATION_FOR_PARAMETER, OI;TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!>super<!>("", x)
}
