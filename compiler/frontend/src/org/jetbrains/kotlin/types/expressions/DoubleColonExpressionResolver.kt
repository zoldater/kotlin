...
@Suppress("EXPERIMENTAL_IS_NOT_ENABLED", "UNCHECKED_CAST")
...
class DoubleColonExpressionResolver(
    ...
    private fun <T : DoubleColonLHS> tryResolveLHS(
        ...
        val lhs = resolve(expression, c)?.let { expressionTypingServices.kotlinTypeChecker.kotlinTypeRefiner.refineLHS(it) }
