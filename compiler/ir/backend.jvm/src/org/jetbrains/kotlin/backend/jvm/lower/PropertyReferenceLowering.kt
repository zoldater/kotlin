    ...
    override fun lower(irClass: IrClass) {
        ...
        irClass.transformChildrenVoid(object : IrElementTransformerVoidWithContext() {
            ...
            private fun createKPropertySubclass(expression: IrMemberAccessExpression): IrClass {
                ...
                val superArgs = if (expression.dispatchReceiver != null || expression.extensionReceiver != null) 1 else 0
                val superConstructor = superClass.constructors.single { it.valueParameters.size == superArgs }
